...
::google::protobuf::internal::DescriptorTable descriptor_table_Block_2eproto = {
  ...
  "\n\013Block.proto\022\004Enze\032\021Transaction.proto\"\263"
  "\001\n\005Block\022\023\n\013nCurVersion\030\001 \001(\005\022\025\n\rhashPre"
  "vBlock\030\002 \001(\t\022\026\n\016hashMerkleRoot\030\003 \001(\t\022\017\n\007"
  "m_uTime\030\004 \001(\r\022\r\n\005uBits\030\005 \001(\r\022\016\n\006uNonce\030\006"
  " \001(\r\022!\n\006vTrans\030\007 \003(\0132\021.Enze.Transaction\022"
  "\023\n\013vMerkleTree\030\010 \003(\tb\006proto3"
,
  "Block.proto", &assign_descriptors_table_Block_2eproto, 228,
};
...
Block::Block(const Block& from)
  : ::google::protobuf::Message(),
      ...
      vmerkletree_(from.vmerkletree_) {
    ...
    switch (tag >> 3) {
      ...
      case 8: {
        ...
        do {
          ptr = Varint::Parse32Inline(ptr, &size);
          GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
          ctx->extra_parse_data().SetFieldName("Enze.Block.vMerkleTree");
          parser_till_end = ::google::protobuf::internal::StringParserUTF8;
          ::std::string* str = msg->add_vmerkletree();
          str->clear();
          object = str;
          if (size > end - ptr) goto len_delim_till_end;
          auto newend = ptr + size;
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 8: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (66 & 0xFF)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->add_vmerkletree()));
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            this->vmerkletree(this->vmerkletree_size() - 1).data(),
            static_cast<int>(this->vmerkletree(this->vmerkletree_size() - 1).length()),
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "Enze.Block.vMerkleTree"));
        } else {
          goto handle_unusual;
        }
        break;
...
void Block::SerializeWithCachedSizes(
  ...
  // uint32 m_uTime = 4;
  if (this->m_utime() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(4, this->m_utime(), output);
  }
  ...
  // repeated string vMerkleTree = 8;
  for (int i = 0, n = this->vmerkletree_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      this->vmerkletree(i).data(), static_cast<int>(this->vmerkletree(i).length()),
      ::google::protobuf::internal::WireFormatLite::SERIALIZE,
      "Enze.Block.vMerkleTree");
    ::google::protobuf::internal::WireFormatLite::WriteString(
      8, this->vmerkletree(i), output);
  }
...
::google::protobuf::uint8* Block::InternalSerializeWithCachedSizesToArray(
  ...
  // uint32 m_uTime = 4;
  if (this->m_utime() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(4, this->m_utime(), target);
  }
  ...
  for (int i = 0, n = this->vmerkletree_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
      ...
      "Enze.Block.vMerkleTree");
    target = ::google::protobuf::internal::WireFormatLite::
      WriteStringToArray(8, this->vmerkletree(i), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Enze.Block)
  ...
  // repeated string vMerkleTree = 8;
  total_size += 1 *
      ::google::protobuf::internal::FromIntSize(this->vmerkletree_size());
  for (int i = 0, n = this->vmerkletree_size(); i < n; i++) {
...
// @@protoc_insertion_point(class_specific_merge_from_start:Enze.Block)
  ...
  vmerkletree_.MergeFrom(from.vmerkletree_);
  if (from.hashprevblock().size() > 0) {
...
void Block::InternalSwap(Block* other) {
  ...
  vmerkletree_.InternalSwap(CastToBase(&other->vmerkletree_));
