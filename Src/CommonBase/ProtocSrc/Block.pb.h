...
class Block : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Enze.Block) */ {
 public:
  ...
  ::google::protobuf::uint32 utime() const;
  void set_utime(::google::protobuf::uint32 value);
...
// uint32 uTime = 4;
inline void Block::clear_utime() {
  utime_ = 0u;
}
inline ::google::protobuf::uint32 Block::utime() const {
  // @@protoc_insertion_point(field_get:Enze.Block.uTime)
  return utime_;
}
inline void Block::set_utime(::google::protobuf::uint32 value) {
  
  utime_ = value;
  // @@protoc_insertion_point(field_set:Enze.Block.uTime)
}
