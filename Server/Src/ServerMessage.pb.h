...
inline ::google::protobuf::uint32 endPoint::localip() const {
  // @@protoc_insertion_point(field_get:endPoint.LocalIp)
  return localip_;
}
inline void endPoint::set_localip(::google::protobuf::uint32 value) {
  
  localip_ = value;
  // @@protoc_insertion_point(field_set:endPoint.LocalIp)
}
...
inline ::google::protobuf::uint32 endPoint::localport() const {
  // @@protoc_insertion_point(field_get:endPoint.Localport)
  return localport_;
}
inline void endPoint::set_localport(::google::protobuf::uint32 value) {
  
  localport_ = value;
  // @@protoc_insertion_point(field_set:endPoint.Localport)
}
